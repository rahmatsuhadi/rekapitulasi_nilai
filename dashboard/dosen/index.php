...
<?php 
    include_once "../../src/Model/DosenModel.php";
    $model = new Dosen();
    $courseList = $model->getAllDosen();
...
?>
            <div class="container-lg ps-5 px-lg-3 mt-4 w-100">
                ...
                <span class="text-danger" style="font-size: 11pt;">*Klik Nama Dosen untuk melihat detail</span>
